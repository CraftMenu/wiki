...
CraftMenu fornece um conjunto abrangente de comandos para gerir menus.
...
```
Abre um menu para si ou outro jogador.

**Exemplos:**
- `/cm abrir template` - Abre o menu template para si
...
/cm fechar [jogador]
```
Fecha o menu ativo para si ou outro jogador.
...
### Eliminar Menu
```
/cm eliminar <nome_menu>
```
Elimina um template de menu existente.
...
/cm imagens backups
```
- `verificar` - Procura por imagens muito grandes
- `corrigir` - Optimiza imagens grandes automaticamente
...
```
/cm depurar grelha
/cm depurar grelha numeros
```
- `/cm depurar grelha` - Alterna a visualização de debug da grelha
- `/cm depurar grelha numeros` - Alterna a exibição dos números das células

### Verificação de Saúde
```
/cm saude
```
Mostra o estado de saúde dos componentes.
